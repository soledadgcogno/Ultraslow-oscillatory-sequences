...
%         C:\Users\xscogno\Dropbox\Paper Waves\Figures Waves Paper\June-July 2021\Raster plots
        ...
        saveas(gcf,strcat('C:\Users\xscogno\Dropbox\Paper Waves\Figures Waves Paper\June-July 2021\Raster plots\V1\',mouse,'_Day',num2str(day),'_Session',num2str(s),'.svg'));
        saveas(gcf,strcat('C:\Users\xscogno\Dropbox\Paper Waves\Figures Waves Paper\June-July 2021\Raster plots\V1\',mouse,'_Day',num2str(day),'_Session',num2str(s),'.fig'));
