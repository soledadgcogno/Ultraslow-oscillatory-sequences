function [peak_freq,peak_psd,goodness]=check_peak_quality_4_f(fourier,freq,thr,freq_low_boundary,freq_upper_boundary)
goodness=1;

fourier_c=fourier;
% fourier=fourier(5:300); %3:15
fourier=fourier(freq_low_boundary:freq_upper_boundary); %3:15
