...
%         
    ...
    % Analysis on initiation during immobility - REQUESTED BY E AND MB
...
%                 continue
    ...
    clear ac_d ac_iwi ac_iwi_2 ac_pre_post alfa angle angular_speed b delta_t distance_run_per_wave  FRp   ...
        ...
        scoret phase_r session_during_wave session_i still_epochs_frames still_epoch_frames ...
%         speed_iwi speed_iwi_2 
end
...
figure
scatter(speed_before_2,speed_after_2,40,'filled')
alpha 0.5
h=refline(1,0)
h.LineStyle='--';
h.Color=[105,105,105]/255;
